...
.icon-checkAll{background:url('IconsExtension/checkAll.png') no-repeat center center;}
.icon-uncheck{background:url('IconsExtension/uncheck.png') no-repeat center center;}
.icon-recheck{background:url('IconsExtension/recheck.png') no-repeat center center;}
...
.icon-batchSelect{background:url('IconsExtension/batchSelect.png') no-repeat center center;}
.icon-file_warning{background:url('IconsExtension/file_warning.png') no-repeat center center;}
.icon-file_warning2{background:url('IconsExtension/file_warning2.png') no-repeat center center;}
