...
$.fn.combo.defaults=$.extend({},$.fn.textbox.defaults,{inputEvents:{click:_9a7,keydown:_9ab,paste:_9ab,drop:_9ab},panelWidth:null,panelHeight:119,panelMinWidth:null,panelMaxWidth:null,panelMinHeight:null,panelMaxHeight:null,panelAlign:"left",multiple:false,selectOnNavigation:true,separator:",",hasDownArrow:true,delay:200,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
...
//添加跨域访问能力
if(opts.jsonp){
$.ajax({type : opts.method,url : opts.url,data : _a29,dataType : "jsonp",jsonp:'callback',
success : function(data) {_a2a(data);},error : function() {_a2b.apply(this, arguments);
}});
}else{
//--元数据---
...
$(this).closest("div.combo-panel").panel("close");
	...
	$(_abg).combo('setValue', '').combo('setText', '');  
	$(this).closest("div.combo-panel").panel("close"); 
